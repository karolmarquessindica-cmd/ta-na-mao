(()=>{
  ...
  function styleGestaoTitle(homeCard){[...homeCard.querySelectorAll('div,span,strong,h1,h2,h3,p')].forEach(el=>{if((el.textContent||'').trim()==='Gestão em Ação'){el.style.fontWeight='900';el.style.fontSize='16px';el.style.lineHeight='1.2';el.style.color='#0C140D';el.style.letterSpacing='-0.01em';}})}
